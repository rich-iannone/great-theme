...
[View on PyPI](https://pypi.org/project/great-docs/)<br>
[Browse source code](https://github.com/rich-iannone/great-docs)<br>
[Report a bug](https://github.com/rich-iannone/great-docs/issues)<br>
...
[Code of conduct](code-of-conduct.qmd)<br>
...
If your package includes items that can't be auto-documented, you can exclude them in your `pyproject.toml`:
